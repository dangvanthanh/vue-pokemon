...
var Pokemon = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"app"},[_c('header',{staticClass:"header",attrs:{"role":"banner"}},[_c('div',{staticClass:"header__inner"},[_c('div',{staticClass:"header__section"},[_vm._m(0),_c('div',{staticClass:"pokemon__search"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.pokemonTerm),expression:"pokemonTerm"}],staticClass:"pokemon__search-textfield",attrs:{"type":"text","name":"name","placeholder":"Search by name or number"},domProps:{"value":_vm._s(_vm.pokemonTerm)},on:{"keyup":_vm.searchPokemon,"input":function($event){if($event.target.composing){ return; }_vm.pokemonTerm=$event.target.value;}}})])])])]),_c('main',{staticClass:"main",attrs:{"role":"main"}},[(!_vm.isLoadingPokeball)?_c('div',{staticClass:"pokemons-loading"},[_vm._m(1)]):_vm._e(),(_vm.isLoadingPokeball)?_c('div',{staticClass:"container"},[_c('div',{staticClass:"pokemons"},_vm._l((_vm.pokemon),function(p){return _c('div',{staticClass:"pokemon"},[_c('figure',{staticClass:"pokemon__sprite",style:({ backgroundColor: p.swatches })},[_c('img',{attrs:{"src":p.sprite}})]),_c('div',{staticClass:"pokemon__content"},[_c('p',{staticClass:"pokemon__id"},[_vm._v(_vm._s(_vm._f("zeros")(p.id)))]),_c('h2',{staticClass:"pokemon__name"},[_vm._v(_vm._s(_vm._f("capitalizes")(p.name)))])])])}))]):_vm._e()])])},staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"header__logo"},[_c('h1',[_vm._v("Pokemon")])])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"pokeball"},[_c('div',{staticClass:"pokeball__button"})])}],
  data: function data () {
    return {
			pokemon: [],
			pokemonTemp: [],
